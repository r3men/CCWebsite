      ...
      <main className="flex flex-col items-center justify-center px-6 py-20 text-center space-y-10">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-xl mx-auto">
            Master cybersecurity concepts — one lesson at a time. Build your foundation in
            digital defense, from passwords to phishing and beyond.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link
            href="/learn"
            className="px-8 py-3 rounded-full bg-blue-600 hover:bg-blue-700 transition-colors text-white font-semibold shadow-lg shadow-blue-600/30"
          >
            Start Learning
          </Link>
